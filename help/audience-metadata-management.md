 ...
 -d '
{
  ...
  "flowSpecId": "f85f7a4e-b5de-4317-aee8-91a7c436cf7f",
  "name": "test mappingAutoFiller",
  "authLevel": "USER",
  "dataPlane": "ACTIVATION",
  "identityNamespaces": {
    "test2": {
    ...
    "test": {
      ...
      "acceptedGlobalNamespaces": {
        "phone": {
          "requiredTransformation": "true"
        }
      }
    }
  },
  "outboundDataType": "SEGMENT",
  "mappingAutoFiller": "SEGMENT_NAME",
  "destinationDelivery": [
    {
      "authenticationRule": "CUSTOMER_AUTHENTICATION",
      "destinationServerId": "d88de647-a352-4824-8b46-354afc7acbff"
    }
  ],
  "id": "fac32a1b-1d05-4dfe-8224-c5ed8db6dcf8"
}'
```
